...
public class FriendlyPingServer {
  ...
  private static final String SENDER_ID = "677203116487";
  private static final String SERVER_API_KEY = "AIzaSyASHpb0cTVSmnR8hq1vc6h1WUy69sqJaKA";
  ...
  private Client createServerClient() {
    ...
    client.name = "Dominator";
    client.registrationToken = SENDER_ID + "@gcm.googleapis.com";
    client.profilePictureUrl ="https://www.google.com/url?sa=i&rct=j&q=&esrc=s&source=images&cd=&cad=rja&uact=8&ved=0ahUKEwjE1IWBzpbNAhWB8x4KHXQwAksQjRwIBw&url=http%3A%2F%2Fwww.ign.com%2Fblogs%2Fr341ity_ch3ck%2F2013%2F02%2F22%2Fpc-roundup-022213&psig=AFQjCNFxL8HS2Z4s5vPnJrjna88l__0c6w&ust=1465412726188163";
    return client;
  }
  ...
  private void pingClient(String toToken, String senderToken) {
    ...
    jNotification.addProperty("body", senderClient.name + " loves you");
